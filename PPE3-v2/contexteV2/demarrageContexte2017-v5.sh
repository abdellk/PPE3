...
/opt/logiciels/librairies/jdk1.8.0_112/bin/java -jar ./peuplement.jar > /dev/null 2>1&
...
export ANT_HOME=/opt/logiciels/librairies/apache-ant-1.9.8
export JAVA_HOME=/opt/logiciels/librairies/jdk1.8.0_112
export JRE_HOME=$JAVA_HOME/jre
export PATH=$ANT_HOME/bin:$JAVA_HOME/bin:$PATH

ant -f build.xml -lib /opt/logiciels/librairies/jsch-0.1.54.jar
